...
import "../../common/static/css/Font.css";
  ...
  return (
    <div className="mainPage">
      ...
      <div className="HBTI-test-container">
        ...
        <button onClick={gotoTest} className="en-font">
          Test
        </button>
      </div>
      <div className="section">
        ...
        <div className="about-HBTI-container">
          <div>
            ...
            <p className="kr-font">
              FITPLE과 함께 HBTI에 대한 정보를 얻고 사용자의 운동 성향을 테스트
              해보세요!
            </p>
            <p className="kr-font">
              HBTI를 통해 자신의 운동 성향을 알 수 있습니다.
            </p>
            <button onClick={goHBTI} className="en-font">
              GO TO HBTI
            </button>
          </div>
        ...
        <div className="match-trainer-container">
          <div>
            ...
            <p className="kr-font">
              FITPLE과 함께 자신에게 맞는 트레이너를 찾고 운동 능력을
              향상시켜보세요!
            </p>
            <p className="kr-font">
              자신과 맞는 트레이너와 함께했을 때 최적의 운동 능력을 발휘할 수
              있습니다.
            </p>
            <button onClick={goMatching} className="en-font">
              MATCH TRAINER
            </button>
          </div>
